...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Service for Relaygator, a short-form video scheduling SaaS for TikTok, YouTube Shorts, and Instagram Reels.",
};

export const termsTopics = [
  "Relaygator is a scheduling tool for uploading one vertical video, preparing platform-specific captions and settings, and scheduling publishing attempts.",
  "Users are responsible for having the required platform permissions, account access, and content rights before uploading or scheduling any video through Relaygator.",
  "Publishing depends on platform APIs, app approvals, account permissions, content rules, and account eligibility. Relaygator cannot guarantee that a scheduled post will publish successfully or remain available after publishing.",
  "Subscriptions and payments for Relaygator are handled through Stripe. Plan details, renewal timing, cancellations, receipts, and invoices should be reviewed through the billing portal when enabled.",
  "Acceptable use prohibits unlawful content, infringement, deceptive activity, spam, platform abuse, attempts to bypass platform review, unauthorized account access, or interference with Relaygator.",
  "Access to Relaygator may be suspended or terminated for misuse, non-payment, security risk, platform policy conflicts, legal risk, or shutdown of the beta service.",
];
    ...
    <main className="min-h-screen bg-neutral-50 text-neutral-950">
      <div className="mx-auto w-full max-w-3xl px-4 py-10 sm:px-6 lg:py-14">
        ...
        <PolicySection title="Customer Accounts and Responsibility">
          <p>
            You are responsible for maintaining access to your Relaygator
        ...
        <PolicySection title="Payments and Subscriptions">
          <p>
            Paid Relaygator plans are billed through Stripe. By starting a paid
        ...
        <PolicySection title="Service Availability">
          <p>
            Relaygator may change, pause, or discontinue features as the product
        ...
        <PolicySection title="Contact">
          <p>
            For questions about these Terms of Service, contact the Relaygator
